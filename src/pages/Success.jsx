                  ...
                  <div className='onboardMain'>
                    ...
                    <div className="onboardIntro sign_section border-bottom-0">
                      ...
                      <div className="onboardStep b_border top_txt">
                        ...
                        <p>You can view our <span className='txt-success-link'><Link>online tutorials</Link></span> to experience the amazing features of our marketplace, or check out our <span className='txt-success-link'><Link>FAQs</Link></span> for any questions that you may have. Additionally, you can always <span className='txt-success-link'><Link>chat</Link></span>  with our helpful team members, or send an <span className='txt-success-link'><Link>email</Link></span>  if you have any questions. We are available 24x7 to assist. Cheers!</p>
