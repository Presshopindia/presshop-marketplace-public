...
const UploadedContentDetails = (props) => {
  ...
  const Audio = data ? data.task_id.content.filter((item) => item.media_type === "audio") : fav?.content_id?.content?.filter((item) => item?.media_type === "audio");
  const Video = data ? data.task_id.content.filter((item) => item.media_type === "video") : fav?.content_id?.content?.filter((item) => item?.media_type === "video");
  const images = data ? data.task_id.content.filter((item) => item.media_type === "image") : fav?.content_id?.content?.filter((item) => item?.media_type === "image");
  const Pdf = data ? data.task_id.content.filter((item) => item.media_type === "pdf") : fav?.content_id?.content?.filter((item) => item?.media_type === "pdf");
  const Doc = data ? data.task_id.content.filter((item) => item.media_type === "doc") : fav?.content_id?.content?.filter((item) => item?.media_type === "doc");
                                  ...
                                  return (
                                    <SwiperSlide key={curr._id}>
                                      {curr?.media_type === "image" ? (
                                        <img src={curr?.watermark || curr?.media} alt={`Image ${curr._id}`} />
