              ...
              <div className="reportsConainter">
                ...
                <div className="rprts_wrap allContent_report theme_card">
                  <Tabs
                    ...
                    onSelect={(e) => { navigate(`/reports/${e}`); window.location.reload() }}
                    activeKey={params?.type}
                  >
                    <Tab eventKey="content" title="Content">
                      <ContentReports timeValuesProps={timeValues} type={params?.type} />
                    </Tab>
                    {/* <Tab eventKey="tasks" title="Tasks">
                      <TaskReports timeValuesProps={timeValues} type={params?.type} />
                    </Tab> */}
                  </Tabs>
                </div>
              </div>
