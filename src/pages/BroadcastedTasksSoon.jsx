    ...
    <>
      ...
      <div className="bg-color">
        <div className="soon-cntent">
          <p><span>Hang in there!</span><br />
            We are building our community of Hoppers.<br />
            Soon, you will be able to broadcast multiple tasks from your desktop, <br /> and source content directly from thousands of our users!</p>
                      ...
                      <CardContent className="homeFeed_body clickable">
                        ...
                        <div className="feedImgTag">
                          <div className="tags_prnt iflex">
                            <div className="post_itm_icns">
                              ...
                              <img className="feedMediaType iconBg" src={Camera} alt="" />
                            </div>
                          </div>
                        ...
                        <div className="feedContent_wrap">
                          ...
                          <div className="feed_dateTime">
                            <small className="feedTime"><MdOutlineWatchLater />12:36 PM, 10 Oct 2022</small>
                            <small className="feedLocation"><GrLocation />Grenfell Tower, London</small>
                          </div>
                        </div>
                      </CardContent>
                      <CardActions className="dash-c-foot feedFooter justify-content-between">
                        <Link to="/viewDetail" className="red_font">View task</Link>
                        <Button variant="primary" className="contentPrice_btn">£350</Button>
                      </CardActions>
                    </Card>
                  </Col>
                  <Col md={4}>
