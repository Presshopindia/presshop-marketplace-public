...
import { blobImageUrl, formatAmountInMillion } from "../component/commonFunction";
...
const FeeddetailCopy = (props) => {
  ...
  const NewExternalChatFun = async (type, offer_amount, initial_offer_price = 0, room) => {
    const obj = {
      image_id: contentId,
                          ...
                          <div className="photo-resize">
                            ...
                            <Swiper
                              ...
                              onSlideChange={(e) => {
                                ...
                                if (data.content[e.activeIndex]?.media_type == "image") {
                                  const img = new Image();
                                  img.src = data.content[e.activeIndex]?.watermark;
                                  img.onload = function () {
                                    setImageSize({ height: img.height, width: img.width })
                                  };
                                }
                              ...
                              {messages && messages.length === 0 ? (
                                ...
                                : (
                                  ...
                                  >
                                    £
                                    {Number(
                                      messages?.find((el) => el.message_type === "accept_mediaHouse_offer" || el.message_type === "decline_mediaHouse_offer")?.amount)?.toLocaleString("en-US", {
                                        maximumFractionDigits: 2,
                                      })}
                                  </Button>
                                )}
                                    ...
                                    <div className="externalText">
                                      ...
                                      <div className="crd chatting_itm sngl_cht d-flex align-items-start">
                                        ...
                                        <div className="cht_txt postedcmnt_info">
                                          ...
                                          <Typography className="comment_text">
                                            Please click the 'Offer' button to make an offer, or simply click 'Buy' to purchase the content
                                          </Typography>
                                        </div>
                                      </div>
                                    </div>
                                            ...
                                            <div className="crd chatting_itm sngl_cht d-flex align-items-start">
                                              ...
                                              <div className="cht_txt postedcmnt_info">
                                                ...
                                                <form
                                                  onSubmit={(e) => {
                                                    e.preventDefault();
                                                    NewExternalChatFun("accept", offer_value, data?.original_ask_price, roomDetails)
                                                  }}
                                                ...
                                                >
                                                  <input
                                                    ...
                                                    type="number"
                                                    value={messages?.length <= 1 ? offer_value : null}
                                                    placeholder={messages?.length > 1 ? `£${curr?.amount}` : "Enter price here ..."}
                                                    onChange={(e) => {
                                                      setOffer_value(
                                                        e.target.value
                                                      );
                                                ...
                                                <div className="cht_txt postedcmnt_info">
                                                  ...
                                                  <div className="usr_upld_opts">
                                                    <button
                                                      ...
                                                      onClick={() => {
                                                        Payment(+((messages?.find((el) => el?.message_type == "Mediahouse_initial_offer"))?.initial_offer_price), data?._id, false, 0, roomDetails);
                                                      }}
                                                    >
                                                      Buy
                                                    </button>
                                              ...
                                              <div className="crd chatting_itm sngl_cht user-data">
                                                ...
                                                <div className="usr_upld_opts user-btn d-flex align-items-center">
                                                  <button className="theme_btn" onClick={() => {
                                                    Payment(+(data?.original_ask_price), data?._id, true, data?.original_ask_price, roomDetails)
                                                  }}>
                                                    Buy
                                                  </button>
                                                  <button className="theme_btn black-btn" onClick={() => NewExternalChatFun("no", curr?.amount, 0, roomDetails)}>
                                                    No
                                                  </button>
                                                </div>
                                              </div>
                                                ...
                                                <div className="cht_txt postedcmnt_info rating-update">
                                                  ...
                                                  <div className="usr_reviews">
                                                    <Rating
                                                      ...
                                                      value={rating}
                                                      initialValue={+(messages?.find((el) => el.message_type == "rating_by_mediahouse")?.rating) || 0}
                                                    ...
                                                    <ul>
                                                      <li onClick={() => handleFeatures("Experience")} className={messages?.find((el) => el?.message_type == "rating_by_mediahouse")?.features?.includes("Experience") || features.includes("Experience") ? "selected clickable" : "clickable"}>Experience</li>
                                                      <li onClick={() => handleFeatures("Easy to use")} className={messages?.find((el) => el?.message_type == "rating_by_mediahouse")?.features?.includes("Easy to use") || features.includes("Easy to use") ? "selected clickable" : "clickable"}>Easy to use</li>
                                                      <li onClick={() => handleFeatures("Connectivity with Hoppers")} className={messages?.find((el) => el?.message_type == "rating_by_mediahouse")?.features?.includes("Connectivity with Hoppers") || features.includes("Connectivity with Hoppers") ? "selected clickable" : "clickable"}>Connectivity with Hoppers</li>
                                                      <li onClick={() => handleFeatures("Pricing")} className={messages?.find((el) => el?.message_type == "rating_by_mediahouse")?.features?.includes("Pricing") || features.includes("Pricing") ? "selected clickable" : "clickable"}>Pricing</li>
                                                      <li onClick={() => handleFeatures("Secure payment")} className={messages?.find((el) => el?.message_type == "rating_by_mediahouse")?.features?.includes("Secure payment") || features.includes("Secure payment") ? "selected clickable" : "clickable"}>Secure payment</li>
                                                      <li onClick={() => handleFeatures("Support")} className={messages?.find((el) => el?.message_type == "rating_by_mediahouse")?.features?.includes("Support") || features.includes("Support") ? "selected clickable" : "clickable"}>Support</li>
                                                    </ul>
                                                    <div className="position-relative">
                                                      ...
                                                      >
                                                        <Form.Control
                                                          ...
                                                          value={messages?.find((el) => el.message_type == "rating_by_mediahouse")?.review || review}
                                                        ></Form.Control>
                                                      </Form.Group>
                                                    </div>
                                                    ...
                                                    <button
                                                      ...
                                                      disabled={messages?.filter((el) => el.message_type == "rating_by_mediahouse")?.length != 0}
                                                    >
                                                      Submit
                                                    </button>
                                                  </div>
