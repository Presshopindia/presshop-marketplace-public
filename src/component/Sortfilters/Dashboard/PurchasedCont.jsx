...
const PurchasedCont = ({ closeContentPurchased, rangeTimeValuesPurchasedContent }) => {
  ...
  const [filterSort, setFilterSort] = useState({ field: "", values: "", type: "puchasedonline" })
  ...
  return (
    <>
      <div className="filter_wrap">
        ...
        <button className="fltr_btn mt-3" onClick={() => { handleFavSortFilter(); handleClose() }}>Apply</button>
      </div>
    </>
  );
};
